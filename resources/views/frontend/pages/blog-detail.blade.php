...
@section('title', __('page_title.blog_details'))
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class=""><a href="{{ route('blogs') }}">Blogs<i
            ...
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="blog-single-main">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author">
                                            ...
                                            <a href="javascript:void(0);">{{ $post->created_at->format('M d, Y') }}</a>
                                            {{-- <a href="javascript:void(0);">5min Read</a> --}}
                                    ...
                                    <div class="content">
                                        @if ($post->quote)
                                            <blockquote class="display-none"> <i class="fa fa-quote-left"></i>
                                ...
                                <div class="share-social">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="content-tags display-none">
                                                <h4>Tags:</h4>
                                                <ul class="tag-inner">
                                                    @php
                        ...
                        <hr />
                        <div class="health-article-main">
                            <div class="health-head">
                                <p>Recent Health Articles</p>
                            </div>
                            <div class="row">
                ...
                <div class="col-lg-4 col-12 display-none">
