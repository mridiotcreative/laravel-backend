...
@section('title', __('page_title.contact_us'))
        ...
        <div class="container">
            <div class="contact-head">
                <div class="row">
                    ...
                    <div class="col-lg-6 contactus-left-main">
                        <div class="contactus-left">
                            <img src="/frontend/img/contact-left.svg" alt="contact">
                        </div>
                    </div>
                    <div class="col-lg-6 col-12 contactus-right-main">
                        <div class="form-main">
                            <div class="title">
                                <h4>Get in touch</h4>
                                <h3>we are here for you how can help you </h3>
                            </div>
                            <form class="form-contact form contact_form" method="post" id="contactForm"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group message">
                                            ...
                                            <textarea name="message" id="message" cols="30" rows="9" placeholder="Enter Message">{{ old('message') }}</textarea>
                                            @error('message')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group button">
                                            <button type="button" name="submit" class="btn btn-contact-form">Send</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            $('#contactForm').validate({
                ...
                messages: {
                    ...
                    subject: {
                        ...
                        minlength: "The subject must be at least 6 characters."
                    },
                    number: {
                        required: "The number field is required.",
                        minlength: "The number must be at least 4 characters."
                    },
                    email: {
                    ...
                    message: {
                        ...
                        minlength: "The message must be at least 20 characters."
                    }
                }
            });
