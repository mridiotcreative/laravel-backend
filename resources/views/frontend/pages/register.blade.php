            ...
            <div class="row">
                <div class="col-lg-6 register-left-main">
                    <div class="register-left">
                        <div class="register-img">
                            <img src="/frontend/img/register-left.svg" alt="">
                        </div>
                ...
                <div class="col-lg-6 register-right-main">
                    <div class="container">
                        ...
                        <form class="form" id="registerFrom" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="firm_name" placeholder="Enter Firm Name"
                                                value="{{ old('firm_name') }}" class="">
                                            @error('name')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div id="uploadArea" class="upload-area">
                                    ...
                                    <div class="col-lg-12 not_in_mr">
                                        <div class="drug">
                                            ...
                                            <input type="text" name="drug_licence_no"
                                                value="{{ old('drug_licence_no') }}" placeholder="Enter Drug Licence No">
                                    ...
                                    <div class="col-lg-12 file-uploader-main">
                                        <div class="gst-label">
                                            <label>Upload Document ( ID Proof )<span
                                                    class="text-danger">*</span></label>
                                        </div>
                                        <div id="dropZoon" class="upload-area__drop-zoon drop-zoon">
                                            <span class="drop-zoon__icon">
                                    ...
                                    <div class="done-btn">
                                        ...
                                        {{-- <button type="button" class="" name="submit">Done</button> --}}
                                    </div>
                                    <!-- End Drop Zoon -->
