...
@section('meta')
    ...
    <meta property="og:image" content="{{ $product_detail->photo[0] }}">
    <meta property="og:description" content="{{ $product_detail->description }}">
@endsection
@section('title', __('page_title.product_details'))
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active">Product Details<i class="fa fa-angle-right"></i></li>
                        ...
                        <div class="col-lg-5 col-12">
                            ...
                            <div class="product-gallery">
                                ...
                                <div class="flexslider-thumbnails">
                                    <ul class="slides">
                                        @foreach ($product_detail->photo as $newPh)
                                            <li data-thumb="{{ $newPh }}" rel="adjustX:10, adjustY:">
                                                <img src="{{ $newPh }}"
                                                    alt="{{ $newPh }}">
                                            </li>
                                        @endforeach
                            ...
                            <div class="product-des">
                                ...
                                <div class="product-buy">
                                    <form method="POST">
                                        ...
                                        <div class="add-to-cart mt-4">
                                            <button type="button" data-id="{{ $product_detail->slug }}"
                                ...
                                <div class="offer-points-main d-none">
                                    <div class="offer-point-img-main">
                                        ...
                                        <div class="offer-right-main">
                                            <div class="offer-head">
                                                <h3>Offers</h3>
                                            </div>
                                            <div class="get-points">
                                                <p>You will get 10 points</p>
                                            </div>
                                            <div class="my-points">
                                                <p>My Points: 140 points</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action-2">
                                                <button class="btn-add-to-cart" data-id="{{ $data->slug }}"
                                                    title="Add to cart" href="#">Add
                                                    to
                                                    cart</button>
                                            </div>
                                        </div>
